        ...
        <header>
            <nav>
                <ol>
                    ...
                    <li id="register" style="float: right;"><a href="register.html#register">REGISTER</a></li>
                </ol>
            </nav>
        </header>
        ...
        <?php 
            ...
            for ($i=0; $i < count($_SESSION['name']); $i++){
                if ($_POST['cancelorder'.$i] == "order"){
                    ...
                    unset($_SESSION['seats'][$i]); //so that it wont update to database: orders
                }
            }
        ?>
